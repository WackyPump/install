...
run_command sudo apt install locales -y
...
if [ "$install_type" -eq 1 ]; then
    run_command sudo apt install ros-humble-desktop -y
else
    run_command sudo apt install ros-humble-ros-base -y
fi
